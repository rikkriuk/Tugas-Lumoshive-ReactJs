    ...
    <section className="container-fluid py-5">
      ...
      <div className="justify-content-center">
        <div className="row overflow-hidden">
          <div className="bg-testimonial border first col-md-4 col-sm-12 mb-4 p-4 position-relative">
            <img
              src={Backtick}
              alt="backtick"
              height="55"
          ...
          <div className="bg-testimonial border border-2 middle col-md-4 col-sm-12 mb-4 p-4 position-relative">
            <img
              src={Backtick}
              alt="backtick"
              height="55"
          ...
          <div className="bg-testimonial border last col-md-4 col-sm-12 mb-4 p-4 position-relative">
            <img
              src={Backtick}
              alt="backtick"
              height="55"
